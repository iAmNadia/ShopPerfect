...
public class ObjectScope: ObjectScopeProtocol, CustomStringConvertible {
    ...
    /// Instantiates an `ObjectScope` with storage factory and descriptionName.
    ///  - Parameters:
    ///     - storageFactory:   Closure for creating an `InstanceStorage`
    ///     - descriptionName:      Description of object scope for `CustomStringConvertible` implementation
